...
def enhanced_advice_with_ehr(inp: SymptomInput):
    ...
    ehr_context = {}
    if hasattr(inp, "patient_id") and inp.patient_id:
        profile_data = FHIRService.get_patient_profile(inp.patient_id)
        if profile_data:
            ehr_context = {
                "ehr_medications": [
    ...
    def build_messages():
        system = (
            ...
            "Consider the patient's existing conditions and medications from their EHR. "
